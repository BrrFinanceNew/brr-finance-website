      ...
      <Container>   
        <Grid item xs={12} md={12} lg={12} >     
          <Typography color="textPrimary" align="center" variant="h3" gutterBottom style={{ marginBottom: '40px' }}>
              ...
              <h2 style={{color: '#fff', textAlign:'center', paddingTop: '20%'  }}>Q1</h2>
              <p style={{ textAlign:'center', color: '#fff' }}>- Airdrop for dedicated supporters ✅</p>      
        </Grid>
        ...
        <Grid container justify="center" spacing={3} style={{}}>
          ...
          <Grid item xs={12} sm={12} lg={6} >  
            <Card>
                <a href='#' target='_blank'><h2 style={{textAlign:'center'}}>Tomb Finance</h2></a>
            </Card>
          </Grid>

          <Grid item xs={12} sm={12} lg={6}>  
            <Card>
                <a href='#' target='_blank'><h2 style={{textAlign:'center'}}>Finance</h2></a>
            </Card>
          </Grid>            
        </Grid>
      </Container>
