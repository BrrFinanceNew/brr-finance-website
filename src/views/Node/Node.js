            ...
            <Container maxWidth="lg">
              ...
              <Box mt={5}>
                ...
                <div hidden={activeBanks.filter((bank) => bank.sectionInUI === 1).length === 0}>
                  ...
                  Earn CASH by staking PancakeSwap LP
                  </Typography> */}
                ...
                <div hidden={activeBanks.filter((bank) => bank.sectionInUI === 0).length === 0}>
                  <Typography color="textPrimary" align="center" variant="h4" gutterBottom style={{marginTop: '20px'}}>
                    Earn EShare By Staking CASH
                  </Typography>
                  <Alert variant="filled" severity="info">
                    CASH pool has ended. Please claim all rewards and remove funds from the pool.
                  </Alert>
                  <Grid container spacing={3} style={{marginTop: '20px'}}>
                    {activeBanks
