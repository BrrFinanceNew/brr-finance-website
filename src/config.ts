...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  Tomb2sharesWftmLPRewardPool: {
    name: 'Earn DEGEN by staking TSHARES-WFTM LP',
    poolId: 1,
    sectionInUI: 0,
  ...
  //   name: 'Earn DEGEN by staking TOMB-TSHARES LP',
  //   poolId: 2,
  //   sectionInUI: 0,
  //   contract: 'Tomb2Shares2ombLPRewardPool',
  //   depositTokenName: 'TOMB-TSHARES LP',
  //   earnTokenName: 'DEGEN',
  //   finished: false,
  //   multiplier: '6000',
  //   site: "https://2omb.finance",
  ...
  /* Tomb2ombWftmLPRewardPool: {
    name: 'Earn DEGEN by staking TOMB-WFTM LP',
    poolId: 2,
    sectionInUI: 0,
