...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      'DEGEN-WFTM LP': ['0x83A52eff2E9D112E9B022399A9fD22a9DB7d33Ae',18],
      'DSHARES-WFTM LP': ['0xd352daC95a91AfeFb112DBBB3463ccfA5EC15b65',18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  Tomb2sharesWftmLPRewardPool: {
    name: 'Earn DEGEN by staking 2SHARES-WFTM LP',
    poolId: 1,
    sectionInUI: 0,
  ...
  //   name: 'Earn DEGEN by staking 2OMB-2SHARES LP',
  //   poolId: 2,
  //   sectionInUI: 0,
  ...
  Tomb2ombWftmLPRewardPool: {
    name: 'Earn DEGEN by staking 2OMB-WFTM LP',
    poolId: 2,
    sectionInUI: 0,
  ...
  TombBelugaRewardPool: {
    name: 'Earn DEGEN by staking BELUGA',
    poolId: 4,
    sectionInUI: 0,
  ...
  TombBifiRewardPool: {
    name: 'Earn DEGEN by staking BIFI',
    poolId: 5,
    sectionInUI: 0,
  ...
  TombMimRewardPool: {
    name: 'Earn DEGEN by staking MIM',
    poolId: 7,
    sectionInUI: 0,
  ...
  TombBloomRewardPool: {
    name: 'Earn DEGEN by staking BLOOM',
    poolId: 8,
    sectionInUI: 0,
  ...
  TombFtmLPTShareRewardPool: {
    name: 'Earn DSHARES by DEGEN-WFTM LP',
    poolId: 0,
    sectionInUI: 2,
  ...
  TshareFtmLPTShareRewardPool: {
    name: 'Earn DSHARES by DSHARES-WFTM LP',
    poolId: 1,
    sectionInUI: 2,
  ...
  TwoshareFtmLPTShareRewardPool: {
    name: 'Earn DSHARES by 2SHARES-WFTM LP',
    poolId: 2,
    sectionInUI: 2,
  ...
  TwoombFtmLPTShareRewardPool: {
    name: 'Earn DSHARES by 2OMB-WFTM LP',
    poolId: 3,
    sectionInUI: 2,
  ...
  //   name: 'Earn DSHARES by 2OMB-2SHARES LP',
  //   poolId: 4,
  //   sectionInUI: 2,
  ...
  Tomb2SHARESFTMRebates: {
    name: 'Bond 2SHARES-WFTM LP, earn DEGEN',
    poolId: 2,
    sectionInUI: 3,
    contract: 'TombFtmRewardPool',
    depositTokenName: '2SHARES-WFTM LP',
  ...
  // TombDEGENFTMRebates: {
  //   name: 'Bond DEGEN-WFTM LP, earn DEGEN',
  //   poolId: 3,
  //   sectionInUI: 3,
  //   contract: 'TombFtmRewardPool',
  //   depositTokenName: 'DEGEN-WFTM LP',
  ...
  //TombDSHARESFTMRebates: {
   // name: 'Bond DSHARES-WFTM LP, earn DEGEN',
   // poolId: 5,
   // sectionInUI: 3,
  //  contract: 'TombFtmRewardPool',
  //  depositTokenName: 'DSHARES-WFTM LP',
