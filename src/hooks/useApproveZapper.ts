...
import { FTM_TICKER, TOMB_TICKER, TSHARE_TICKER, ZAPPER_ROUTER_ADDR, BUSD_TICKER } from '../utils/constants';
...
function useApproveZapper(zappingToken: string): [ApprovalState, () => Promise<void>] {
  ...
  else if (zappingToken === BUSD_TICKER) token = tombFinance.BUSD;
